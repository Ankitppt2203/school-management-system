...
public class StudentRequestDTO {
    ...
    public java.util.List<Long> getCourseIds() {
        return courseIds;
    }

    public void setCourseIds(java.util.List<Long> courseIds) {
    ...
    public java.util.Map<String, String> getAdmissionDetails() {
        return admissionDetails;
    }

    public void setAdmissionDetails(java.util.Map<String, String> admissionDetails) {
